...
.method private static makeHeapDump(Ljava/lang/String;)V
    ...
    const-string v9, "/data free space is : "
    ...
    const-string v8, "/data free space is lower than 512MB. So do not make heap dump!!!"
    ...
    const-string v9, "StatFs Exception : "
    ...
    const-string v8, "##### begin to write hprof data to system_server_oom_hprof_data"
    ...
    const-string v8, "_oom_hprof_data"
    ...
    const-string v8, "##### end to write hprof data to system_server_oom_hprof_data"

    invoke-static {v7, v8}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_87
    .catch Ljava/io/IOException; {:try_start_5d .. :try_end_87} :catch_88
    ...
    const-string/jumbo v9, "writeHprofDataToFile: caught "
