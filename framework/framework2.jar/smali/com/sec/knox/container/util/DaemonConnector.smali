...
.method private listenToSocket()V
    ...
    :try_end_6b
    .catchall {:try_start_67 .. :try_end_6b} :catchall_218
    ...
    :try_end_96
    .catch Ljava/io/IOException; {:try_start_6d .. :try_end_96} :catch_236
    .catchall {:try_start_6d .. :try_end_96} :catchall_218
    ...
    monitor-exit v16
    :try_end_9c
    .catchall {:try_start_97 .. :try_end_9c} :catchall_218
    ...
    :try_end_a1
    .catch Ljava/io/IOException; {:try_start_9e .. :try_end_a1} :catch_21b
    ...
    move-object/from16 v17, v0
    :try_end_ce
    .catchall {:try_start_c8 .. :try_end_ce} :catchall_1d7
    ...
    :try_end_f9
    .catch Ljava/io/IOException; {:try_start_d0 .. :try_end_f9} :catch_1f9
    .catchall {:try_start_d0 .. :try_end_f9} :catchall_1d7
    ...
    monitor-exit v16
    :try_end_102
    .catchall {:try_start_fb .. :try_end_102} :catchall_1d7
    ...
    :try_end_107
    .catch Ljava/io/IOException; {:try_start_104 .. :try_end_107} :catch_1da
    ...
    invoke-direct {v0, v1}, Lcom/sec/knox/container/util/DaemonConnector;->loge(Ljava/lang/String;)V
    :try_end_216
    .catchall {:try_start_1fa .. :try_end_216} :catchall_1d7
    ...
    invoke-direct {v0, v15}, Lcom/sec/knox/container/util/DaemonConnector;->loge(Ljava/lang/String;)V
    :try_end_251
    .catchall {:try_start_237 .. :try_end_251} :catchall_218
...
.method public varargs execute(ILjava/lang/String;[Ljava/lang/Object;)[Lcom/sec/knox/container/util/DaemonEvent;
    ...
    .line 298
    .local v8, "events":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/sec/knox/container/util/DaemonEvent;>;"
    move-object/from16 v0, p0
    ...
    monitor-exit v15
    :try_end_7e
    .catchall {:try_start_6b .. :try_end_7e} :catchall_7c
    ...
    :try_end_94
    .catch Ljava/lang/Exception; {:try_start_7f .. :try_end_94} :catch_c1
    ...
    .line 330
    .local v7, "event":Lcom/sec/knox/container/util/DaemonEvent;
    :cond_96
    move-object/from16 v0, p0
    ...
    .line 322
    .end local v7    # "event":Lcom/sec/knox/container/util/DaemonEvent;
    :catch_c1
    move-exception v4
    ...
    throw v14
    :try_end_cd
    .catchall {:try_start_c2 .. :try_end_cd} :catchall_7c

    .line 335
    .end local v4    # "e":Ljava/lang/Exception;
    .restart local v7    # "event":Lcom/sec/knox/container/util/DaemonEvent;
    :cond_cd
    new-instance v14, Ljava/lang/StringBuilder;
