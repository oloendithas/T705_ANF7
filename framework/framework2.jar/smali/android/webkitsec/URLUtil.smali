.class public final Landroid/webkitsec/URLUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/webkitsec/URLUtil;->CONTENT_DISPOSITION_PATTERN:Ljava/util/regex/Pattern;
...
.method public static decode([B)[B
    ...
    invoke-static {v6}, Landroid/webkitsec/URLUtil;->parseHex(B)I
    ...
    invoke-static {v7}, Landroid/webkitsec/URLUtil;->parseHex(B)I
...
.method public static final guessFileName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 308
    invoke-static {p1}, Landroid/webkitsec/URLUtil;->parseContentDisposition(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8, p2}, Landroid/webkitsec/MimeTypeMap;->getExtensionFromMimeType(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8, v9}, Landroid/webkitsec/MimeTypeMap;->getMimeTypeFromExtension(Ljava/lang/String;)Ljava/lang/String;
...
.method public static isNetworkUrl(Ljava/lang/String;)Z
    ...
    :cond_a
    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isHttpUrl(Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_16

    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isHttpsUrl(Ljava/lang/String;)Z
...
.method public static isValidUrl(Ljava/lang/String;)Z
    ...
    :cond_a
    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isAssetUrl(Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_3a

    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isResourceUrl(Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_3a

    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isFileUrl(Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_3a

    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isAboutUrl(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isJavaScriptUrl(Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_3a

    invoke-static {p0}, Landroid/webkitsec/URLUtil;->isContentUrl(Ljava/lang/String;)Z
...
.method static verifyURLEncoding(Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Landroid/webkitsec/URLUtil;->parseHex(B)I
