...
.method constructor <init>(Landroid/widget/AbsListView;)V
    ...
    .line 5770
    # getter for: Landroid/widget/AbsListView;->USE_SET_INTEGRATOR_HAPTIC:Z
    invoke-static {p1}, Landroid/widget/AbsListView;->access$2400(Landroid/widget/AbsListView;)Z
    ...
    # getter for: Landroid/widget/AbsListView;->mHapticPreDrawListener:Landroid/view/HapticPreDrawListener;
    invoke-static {p1}, Landroid/widget/AbsListView;->access$2500(Landroid/widget/AbsListView;)Landroid/view/HapticPreDrawListener;
...
.method edgeReached(I)V
    ...
    invoke-static {v2}, Landroid/widget/AbsListView;->access$3000(Landroid/widget/AbsListView;)Z
    ...
    invoke-static {v2}, Landroid/widget/AbsListView;->access$3100(Landroid/widget/AbsListView;)Landroid/widget/EdgeEffect;
    ...
    invoke-static {v2}, Landroid/widget/AbsListView;->access$3200(Landroid/widget/AbsListView;)Landroid/widget/EdgeEffect;
...
.method endFling()V
    ...
    invoke-static {v0}, Landroid/widget/AbsListView;->access$3300(Landroid/widget/AbsListView;)V
...
.method public run()V
    ...
    invoke-static/range {v2 .. v11}, Landroid/widget/AbsListView;->access$3900(Landroid/widget/AbsListView;IIIIIIIIZ)Z
    ...
    # getter for: Landroid/view/View;->mPaddingBottom:I
    invoke-static {v3}, Landroid/widget/AbsListView;->access$3600(Landroid/widget/AbsListView;)I
    ...
    # getter for: Landroid/view/View;->mPaddingTop:I
    invoke-static {v3}, Landroid/widget/AbsListView;->access$3700(Landroid/widget/AbsListView;)I
    ...
    # getter for: Landroid/view/View;->mScrollY:I
    invoke-static {v2}, Landroid/widget/AbsListView;->access$4000(Landroid/widget/AbsListView;)I
    ...
    # invokes: Landroid/view/View;->overScrollBy(IIIIIIIIZ)Z
    invoke-static/range {v5 .. v14}, Landroid/widget/AbsListView;->access$4100(Landroid/widget/AbsListView;IIIIIIIIZ)Z
