...
.method protected computePopupPositionInternal(Landroid/graphics/Rect;Landroid/graphics/Rect;II)V
    ...
    .line 1276
    :cond_d2
    sparse-switch v2, :sswitch_data_4b4
    ...
    if-le v12, v13, :cond_2b3

    .line 1437
    const/16 v12, 0x5050

    if-ne v9, v12, :cond_291
    ...
    if-le v12, v13, :cond_47c

    .line 1513
    const/16 v12, 0x5050

    if-ne v9, v12, :cond_451
...
.method protected isHoveringSettingEnabled(I)Z
    ...
    .line 382
    invoke-virtual {p0, p1}, Landroid/widget/HoverPopupWindow;->isMouseHoveringSettingsEnabled(I)Z
...
.method public isLockScreenMode()Z
    ...
    :try_end_26
    .catch Landroid/os/RemoteException; {:try_start_23 .. :try_end_26} :catch_40
...
.method protected isMouseHoveringSettingsEnabled(I)Z
    ...
    const-string/jumbo v4, "mouse_hovering"
    ...
    const-string/jumbo v4, "mouse_hovering_icon_label"
    ...
    .end local v0    # "isMouseHoveringOn":Z
    :cond_27
    move v0, v2
    ...
    .line 474
    .restart local v0    # "isMouseHoveringOn":Z
    :cond_29
    const/4 v3, 0x3
    ...
    const-string/jumbo v4, "mouse_hovering_information_preview"
    ...
    const-string/jumbo v4, "mouse_hovering_progress_bar_preview"
...
.method protected showPenPointEffect(Z)V
    ...
    invoke-static {v1, v2}, Landroid/view/PointerIcon;->setHoveringSpenIcon(II)V
    :try_end_26
    .catch Landroid/os/RemoteException; {:try_start_23 .. :try_end_26} :catch_2a
