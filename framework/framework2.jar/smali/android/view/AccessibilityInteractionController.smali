...
.method private findAccessibilityNodeInfoByAccessibilityIdUiThread(Landroid/os/Message;)V
    ...
    iget-object v9, v9, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;
    :try_end_26
    .catchall {:try_start_1c .. :try_end_26} :catchall_76
    ...
    invoke-interface {v4}, Ljava/util/List;->clear()V
    :try_end_3d
    .catch Landroid/os/RemoteException; {:try_start_28 .. :try_end_3d} :catch_6f
    ...
    :try_end_59
    .catchall {:try_start_3e .. :try_end_59} :catchall_76
    ...
    invoke-interface {v4}, Ljava/util/List;->clear()V
    :try_end_6e
    .catch Landroid/os/RemoteException; {:try_start_59 .. :try_end_6e} :catch_6f
...
.method private findAccessibilityNodeInfosByTextUiThread(Landroid/os/Message;)V
    ...
    move-object/from16 v18, v0
    :try_end_3c
    .catchall {:try_start_22 .. :try_end_3c} :catchall_11c
    ...
    :try_end_5f
    .catch Landroid/os/RemoteException; {:try_start_3e .. :try_end_5f} :catch_b5
    ...
    :try_end_92
    .catchall {:try_start_60 .. :try_end_92} :catchall_11c
    ...
    invoke-interface {v4, v9, v11}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_b4
    .catch Landroid/os/RemoteException; {:try_start_93 .. :try_end_b4} :catch_b5
    ...
    :try_end_11b
    .catchall {:try_start_b7 .. :try_end_11b} :catchall_11c
    ...
    invoke-interface {v4, v9, v11}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_13e
    .catch Landroid/os/RemoteException; {:try_start_11d .. :try_end_13e} :catch_13f
...
.method private findAccessibilityNodeInfosByViewIdUiThread(Landroid/os/Message;)V
    ...
    iget-object v10, v10, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;
    :try_end_28
    .catchall {:try_start_1e .. :try_end_28} :catchall_a5
    ...
    invoke-interface {v2, v4, v5}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_3c
    .catch Landroid/os/RemoteException; {:try_start_2a .. :try_end_3c} :catch_70
    ...
    :try_end_5a
    .catchall {:try_start_3d .. :try_end_5a} :catchall_a5
    ...
    :try_end_92
    .catchall {:try_start_72 .. :try_end_92} :catchall_a5
    ...
    invoke-interface {v2, v4, v5}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_a4
    .catch Landroid/os/RemoteException; {:try_start_92 .. :try_end_a4} :catch_70
    ...
    invoke-interface {v2, v4, v5}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfosResult(Ljava/util/List;I)V
    :try_end_b8
    .catch Landroid/os/RemoteException; {:try_start_a6 .. :try_end_b8} :catch_b9
...
.method private findFocusUiThread(Landroid/os/Message;)V
    ...
    :try_end_2e
    .catchall {:try_start_20 .. :try_end_2e} :catchall_7f
    ...
    :try_end_46
    .catch Landroid/os/RemoteException; {:try_start_30 .. :try_end_46} :catch_c6
    ...
    throw v14
    :try_end_7f
    .catchall {:try_start_47 .. :try_end_7f} :catchall_7f
    ...
    invoke-interface {v3, v6, v8}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfoResult(Landroid/view/accessibility/AccessibilityNodeInfo;I)V
    :try_end_99
    .catch Landroid/os/RemoteException; {:try_start_80 .. :try_end_99} :catch_111
    ...
    :try_end_ac
    .catchall {:try_start_9a .. :try_end_ac} :catchall_7f
    ...
    invoke-interface {v3, v6, v8}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfoResult(Landroid/view/accessibility/AccessibilityNodeInfo;I)V
    :try_end_c5
    .catch Landroid/os/RemoteException; {:try_start_af .. :try_end_c5} :catch_c6
    ...
    :try_end_10f
    .catchall {:try_start_c9 .. :try_end_10f} :catchall_7f
...
.method private focusSearchUiThread(Landroid/os/Message;)V
    ...
    iget-object v10, v10, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;
    :try_end_22
    .catchall {:try_start_18 .. :try_end_22} :catchall_71
    ...
    invoke-virtual {v7}, Landroid/view/View;->createAccessibilityNodeInfo()Landroid/view/accessibility/AccessibilityNodeInfo;
    :try_end_56
    .catchall {:try_start_37 .. :try_end_56} :catchall_71
    ...
    invoke-interface {v2, v6, v5}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setFindAccessibilityNodeInfoResult(Landroid/view/accessibility/AccessibilityNodeInfo;I)V
    :try_end_84
    .catch Landroid/os/RemoteException; {:try_start_72 .. :try_end_84} :catch_85
...
.method private perfromAccessibilityActionUiThread(Landroid/os/Message;)V
    ...
    iget-object v11, v11, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;
    :try_end_25
    .catchall {:try_start_1b .. :try_end_25} :catchall_6a
    ...
    :try_end_31
    .catch Landroid/os/RemoteException; {:try_start_27 .. :try_end_31} :catch_5c
    ...
    :try_end_68
    .catchall {:try_start_5e .. :try_end_68} :catchall_6a
    ...
    invoke-interface {v4, v8, v6}, Landroid/view/accessibility/IAccessibilityInteractionConnectionCallback;->setPerformAccessibilityActionResult(ZI)V
    :try_end_75
    .catch Landroid/os/RemoteException; {:try_start_6b .. :try_end_75} :catch_76
