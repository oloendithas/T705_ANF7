...
.method public static create(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Landroid/printservice/PrintServiceInfo;
    ...
    invoke-virtual {v14, v8, v15}, Landroid/content/pm/PackageItemInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_1b .. :try_end_34} :catch_84
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1b .. :try_end_34} :catch_a0
    .catchall {:try_start_1b .. :try_end_34} :catchall_c9
    ...
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_41 .. :try_end_67} :catch_84
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_41 .. :try_end_67} :catch_a0
    .catchall {:try_start_41 .. :try_end_67} :catchall_c9
    ...
    invoke-static {v14, v15}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_c5
    .catchall {:try_start_69 .. :try_end_c5} :catchall_c9
