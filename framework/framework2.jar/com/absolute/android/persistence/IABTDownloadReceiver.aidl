 ...
 *
 * See {@link ABTPersistenceManager#downloadApk(String, String, String, String, IABTDownloadReceiver)}.
 *  
 */
interface IABTDownloadReceiver {
     ...
     *
     * @param apkBytes The size of the file being downloaded in bytes.
     *
     ...
     * from the server.
     * {@link ABTPersistenceManager#downloadApk(String, String, String, String, IABTDownloadReceiver)}.
     *
     * When implementing this callback method, do not invoke any long running or blocking 
     * functions.
     *
