...
.method public declared-synchronized getImmutableIndex()Llibcore/icu/AlphabeticIndex$ImmutableIndex;
    ...
    iget-wide v1, p0, Llibcore/icu/AlphabeticIndex;->peer:J

    invoke-static {v1, v2}, Llibcore/icu/AlphabeticIndex;->buildImmutableIndex(J)J

    move-result-wide v1

    const/4 v3, 0x0

    invoke-direct {v0, v1, v2, v3}, Llibcore/icu/AlphabeticIndex$ImmutableIndex;-><init>(JLlibcore/icu/AlphabeticIndex$1;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
