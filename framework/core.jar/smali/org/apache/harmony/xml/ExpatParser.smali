...
.method private parseFragment(Ljava/io/InputStream;)V
    ...
    .line 513
    :try_start_0
    iget-wide v1, p0, Lorg/apache/harmony/xml/ExpatParser;->pointer:J

    const/4 v4, 0x0

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, Lorg/apache/harmony/xml/ExpatParser;->appendBytes(J[BII)V
    :try_end_0
    ...
    .line 515
    .local v6, "e":Lorg/apache/harmony/xml/ExpatException;
    new-instance v0, Lorg/apache/harmony/xml/ExpatParser$ParseException;

    invoke-virtual {v6}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lorg/apache/harmony/xml/ExpatParser;->locator:Lorg/xml/sax/Locator;

    const/4 v4, 0x0

    invoke-direct {v0, v1, v2, v4}, Lorg/apache/harmony/xml/ExpatParser$ParseException;-><init>(Ljava/lang/String;Lorg/xml/sax/Locator;Lorg/apache/harmony/xml/ExpatParser$1;)V

    throw v0

    .line 518
    .end local v6    # "e":Lorg/apache/harmony/xml/ExpatException;
    :cond_0
    return-void
.end method
...
.method private parseFragment(Ljava/io/Reader;)V
    ...
    invoke-direct/range {v0 .. v5}, Lorg/apache/harmony/xml/ExpatParser;->appendChars(J[CII)V
    :try_end_0
    .catch Lorg/apache/harmony/xml/ExpatException; {:try_start_0 .. :try_end_0} :catch_0
...
.method append(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2, p1, v3}, Lorg/apache/harmony/xml/ExpatParser;->appendString(JLjava/lang/String;Z)V
    :try_end_0
    .catch Lorg/apache/harmony/xml/ExpatException; {:try_start_0 .. :try_end_0} :catch_0
...
.method append([BII)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lorg/apache/harmony/xml/ExpatParser$ParseException;-><init>(Ljava/lang/String;Lorg/xml/sax/Locator;Lorg/apache/harmony/xml/ExpatParser$1;)V
...
.method cloneAttributes()Lorg/xml/sax/Attributes;
    ...
    .line 612
    .local v3, "clonePointer":J
    new-instance v0, Lorg/apache/harmony/xml/ExpatParser$ClonedAttributes;

    iget-wide v1, p0, Lorg/apache/harmony/xml/ExpatParser;->pointer:J

    iget v5, p0, Lorg/apache/harmony/xml/ExpatParser;->attributeCount:I

    const/4 v6, 0x0

    invoke-direct/range {v0 .. v6}, Lorg/apache/harmony/xml/ExpatParser$ClonedAttributes;-><init>(JJILorg/apache/harmony/xml/ExpatParser$1;)V
...
.method finish()V
    ...
    invoke-direct {p0, v1, v2, v3, v4}, Lorg/apache/harmony/xml/ExpatParser;->appendString(JLjava/lang/String;Z)V
    :try_end_0
    .catch Lorg/apache/harmony/xml/ExpatException; {:try_start_0 .. :try_end_0} :catch_0
...
.method handleExternalEntity(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 249
    iget-object v4, p0, Lorg/apache/harmony/xml/ExpatParser;->xmlReader:Lorg/apache/harmony/xml/ExpatReader;

    iget-object v12, v4, Lorg/apache/harmony/xml/ExpatReader;->entityResolver:Lorg/xml/sax/EntityResolver;
    ...
    .line 272
    .local v10, "baseUri":Ljava/net/URI;
    invoke-virtual {v10, v14}, Ljava/net/URI;->resolve(Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 283
    .end local v10    # "baseUri":Ljava/net/URI;
    ...
    iget-wide v7, p0, Lorg/apache/harmony/xml/ExpatParser;->pointer:J

    move-object/from16 v0, p1

    invoke-static {v7, v8, v0}, Lorg/apache/harmony/xml/ExpatParser;->createEntityParser(JLjava/lang/String;)J
    ...
    .local v5, "pointer":J
    :try_start_1
    new-instance v2, Lorg/apache/harmony/xml/ExpatParser$EntityParser;
    ...
    invoke-direct/range {v2 .. v9}, Lorg/apache/harmony/xml/ExpatParser$EntityParser;-><init>(Ljava/lang/String;Lorg/apache/harmony/xml/ExpatReader;JLjava/lang/String;Ljava/lang/String;Lorg/apache/harmony/xml/ExpatParser$1;)V

    .line 311
    .local v2, "entityParser":Lorg/apache/harmony/xml/ExpatParser$EntityParser;
    invoke-direct {p0, v2, v13}, Lorg/apache/harmony/xml/ExpatParser;->parseExternalEntity(Lorg/apache/harmony/xml/ExpatParser;Lorg/xml/sax/InputSource;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 313
    invoke-static {v5, v6}, Lorg/apache/harmony/xml/ExpatParser;->releaseParser(J)V

    goto :goto_0

    .line 277
    .end local v2    # "entityParser":Lorg/apache/harmony/xml/ExpatParser$EntityParser;
    .end local v3    # "encoding":Ljava/lang/String;
    .end local v5    # "pointer":J
    ...
    const-string v7, "Could not resolve \'"
    ...
    iget-object v7, p0, Lorg/apache/harmony/xml/ExpatParser;->systemId:Ljava/lang/String;
    ...
    iget-object v7, p0, Lorg/apache/harmony/xml/ExpatParser;->locator:Lorg/xml/sax/Locator;
    ...
    invoke-static {v4, v11}, Ljava/lang/System;->logI(Ljava/lang/String;Ljava/lang/Throwable;)V
