...
.method private doInvokeAny(Ljava/util/Collection;ZJ)Ljava/lang/Object;
    ...
    .line 119
    .local v11, "futures":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/util/concurrent/Future<TT;>;>;"
    ...
    check-cast v17, Ljava/util/concurrent/Callable;
    ...
    .restart local v10    # "f":Ljava/util/concurrent/Future;, "Ljava/util/concurrent/Future<TT;>;"
    ...
    invoke-direct {v7}, Ljava/util/concurrent/ExecutionException;-><init>()V
    :try_end_3
    ...
    invoke-direct/range {v17 .. v17}, Ljava/util/concurrent/TimeoutException;-><init>()V
    ...
    invoke-direct {v7, v15}, Ljava/util/concurrent/ExecutionException;-><init>(Ljava/lang/Throwable;)V
    :try_end_5
...
.method public invokeAll(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/util/List;
    ...
    .line 238
    .local v13, "t":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    move-object/from16 v0, p0

    invoke-virtual {v0, v13}, Ljava/util/concurrent/AbstractExecutorService;->newTaskFor(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/RunnableFuture;
    ...
    .end local v13    # "t":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    :catchall_0
    move-exception v15
    ...
    invoke-interface {v15, v0}, Ljava/util/concurrent/Future;->cancel(Z)Z
    ...
    invoke-virtual {v0, v15}, Ljava/util/concurrent/AbstractExecutorService;->execute(Ljava/lang/Runnable;)V
    ...
    invoke-interface/range {v15 .. v16}, Ljava/util/concurrent/Future;->cancel(Z)Z
    ...
    .line 270
    .local v14, "toe":Ljava/util/concurrent/TimeoutException;
    if-nez v5, :cond_8
    ...
    .end local v14    # "toe":Ljava/util/concurrent/TimeoutException;
    :cond_6
    const/4 v5, 0x1
