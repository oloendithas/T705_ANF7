...
.method private getWindowsOnScreenLocked(Landroid/util/SparseArray;)V
    ...
    invoke-static {v5}, Lcom/android/server/wm/DisplayMagnifier;->access$100(Lcom/android/server/wm/DisplayMagnifier;)Lcom/android/server/wm/WindowManagerService;
...
.method public drawWindowIfNeededLocked()V
    ...
    # getter for: Lcom/android/server/wm/DisplayMagnifier;->mInputMethodVisiable:Z
    invoke-static {v0}, Lcom/android/server/wm/DisplayMagnifier;->access$900(Lcom/android/server/wm/DisplayMagnifier;)Z
    ...
    .line 485
    iput-boolean v1, p0, Lcom/android/server/wm/DisplayMagnifier$MagnifiedViewport;->mFullRedrawNeeded:Z
...
.method public onRotationChangedLocked()V
    ...
    # getter for: Lcom/android/server/wm/DisplayMagnifier;->mWindowManagerService:Lcom/android/server/wm/WindowManagerService;
    invoke-static {v4}, Lcom/android/server/wm/DisplayMagnifier;->access$100(Lcom/android/server/wm/DisplayMagnifier;)Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-static {v3}, Lcom/android/server/wm/DisplayMagnifier;->access$200(Lcom/android/server/wm/DisplayMagnifier;)Landroid/os/Handler;
...
.method public recomputeBoundsLocked()V
    ...
    invoke-static {v3}, Lcom/android/server/wm/DisplayMagnifier;->access$500(Lcom/android/server/wm/DisplayMagnifier;)Landroid/graphics/Region;
    ...
    # getter for: Lcom/android/server/wm/DisplayMagnifier;->mWindowManagerService:Lcom/android/server/wm/WindowManagerService;
    invoke-static {v3}, Lcom/android/server/wm/DisplayMagnifier;->access$100(Lcom/android/server/wm/DisplayMagnifier;)Lcom/android/server/wm/WindowManagerService;
...
.method public updateMagnificationSpecLocked(Landroid/view/MagnificationSpec;)V
    ...
    # getter for: Lcom/android/server/wm/DisplayMagnifier;->mHandler:Landroid/os/Handler;
    invoke-static {v0}, Lcom/android/server/wm/DisplayMagnifier;->access$200(Lcom/android/server/wm/DisplayMagnifier;)Landroid/os/Handler;
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/server/wm/DisplayMagnifier$MagnifiedViewport;->setMagnifiedRegionBorderShownLocked(ZZ)V
