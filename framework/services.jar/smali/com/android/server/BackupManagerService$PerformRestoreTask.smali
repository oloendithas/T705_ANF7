...
.method downloadRestoreData()V
    ...
    iget-object v0, p0, Lcom/android/server/BackupManagerService$PerformRestoreTask;->mRestorePackages:Ljava/util/ArrayList;

    const/4 v4, 0x0

    new-array v4, v4, [Landroid/content/pm/PackageInfo;
    ...
    invoke-interface {v1, v2, v3, v0}, Lcom/android/internal/backup/IBackupTransport;->startRestore(J[Landroid/content/pm/PackageInfo;)I
    ...
    .line 4807
    iget v0, p0, Lcom/android/server/BackupManagerService$PerformRestoreTask;->mStatus:I
    ...
    const-string v1, "Error starting restore operation"
    ...
    const-string v1, "Error communicating with transport for restore"
    ...
    :cond_0
    sget-object v0, Lcom/android/server/BackupManagerService$RestoreState;->PM_METADATA:Lcom/android/server/BackupManagerService$RestoreState;
...
.method restoreNextAgent()V
    ...
    invoke-static {v8, v9, v6}, Lcom/android/server/BackupManagerService;->access$2200(Lcom/android/server/BackupManagerService;[Landroid/content/pm/Signature;Landroid/content/pm/PackageInfo;)Z
...
.method restorePmMetadata()V
    ...
    const-string v5, "Performing user data restore failed - no restore data available "
    ...
    const-string v1, "Error getting first restore package"
    ...
    const-string v1, "No restore data available"
    ...
    iget-wide v2, p0, Lcom/android/server/BackupManagerService$PerformRestoreTask;->mStartRealtime:J
    ...
    const-string v2, "Expected restore data for \"@pm@\", found only \""
    ...
    const-string v3, "Package manager data missing"
    ...
    .line 4872
    .local v8, "omPackage":Landroid/content/pm/PackageInfo;
    const-string v0, "@pm@"
    ...
    iget-object v2, p0, Lcom/android/server/BackupManagerService$PerformRestoreTask;->mAgentPackages:Ljava/util/List;
    ...
    iget-boolean v2, p0, Lcom/android/server/BackupManagerService$PerformRestoreTask;->mNeedFullBackup:Z

    invoke-virtual {p0, v8, v0, v1, v2}, Lcom/android/server/BackupManagerService$PerformRestoreTask;->initiateOneRestore(Landroid/content/pm/PackageInfo;ILandroid/app/IBackupAgent;Z)V
    ...
    const-string v1, "No restore metadata available, so not restoring settings"
    ...
    const-string v3, "Package manager restore metadata missing"
