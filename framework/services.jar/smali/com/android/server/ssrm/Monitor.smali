...
.field static final MSG_BROADCAST_INTENT:I = 0x2

.field static final MSG_CFMS_COMMAND:I = 0x3

.field static final MSG_FOREGROUND_APP:I = 0x1

.field static final MSG_RECHECK_FG_APP:I = 0x8

.field static final MSG_RELEASE_SIOP_DEFERING:I = 0x5

.field static final MSG_REVIEW_APK:I = 0x4

.field static final MSG_WIFI_CHECK:I = 0x7

.field public static final MSG_WLUC:I = 0x6
...
.field private static sKnoxVer2:Z


# instance fields
.field final ACL_SYSFS_PATH:Ljava/lang/String;
...
.field mLocationBundling:Lcom/android/server/ssrm/fgapps/LocationBundling;
...
.field mWluc:Lcom/android/server/ssrm/wluc/Wluc;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lcom/android/server/ssrm/Monitor;->x([I)Ljava/lang/String;
    ...
    .line 461
    sput-boolean v2, Lcom/android/server/ssrm/Monitor;->sKnoxVer2:Z
...
.method private constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;)V
    ...
    invoke-static {v8}, Lcom/android/server/ssrm/Monitor;->x([I)Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/server/ssrm/Monitor;->ACTION_MAX_BRIGHTNESS_CHANGED:Ljava/lang/String;
    ...
    iput-object v8, p0, Lcom/android/server/ssrm/Monitor;->ACL_SYSFS_PATH:Ljava/lang/String;
    ...
    iput v8, p0, Lcom/android/server/ssrm/Monitor;->mWifiCount:I
    ...
    invoke-static {v9}, Lcom/android/server/ssrm/Monitor;->x([I)Ljava/lang/String;
    ...
    sput-boolean v8, Lcom/android/server/ssrm/Monitor;->sKnoxVer2:Z

    .line 599
    sget-object v9, Lcom/android/server/ssrm/Monitor;->TAG:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Knox version : "

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    sget-boolean v8, Lcom/android/server/ssrm/Monitor;->sKnoxVer2:Z
    ...
    invoke-static {v9, v8}, Lcom/android/server/ssrm/SSRMUtil;->logOnEng(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static checkPrefixAndMarkKnoxSystemProperty(Ljava/lang/String;)V
    .locals 2
    ...
    sput-boolean v0, Lcom/android/server/ssrm/DeviceStatus;->sKnoxMode:Z
...
.method private getPolicyXMLFromLocalOrResource()Ljava/io/InputStream;
    ...
    invoke-static {v10}, Lcom/android/server/ssrm/Monitor;->x([I)Ljava/lang/String;
...
.method private onBootCompleted()V
    ...
    sget-boolean v1, Lcom/android/server/ssrm/Feature;->MODEL_T:Z
    ...
    .line 1983
    invoke-direct {p0}, Lcom/android/server/ssrm/Monitor;->requestWlucPolicyUpdate()V

    .line 1985
    invoke-static {}, Lcom/android/server/ssrm/HotGameList;->updateDssPolicy()V
...
.method private onSecurePlaybackStarted()V
    ...
    iget-object v1, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NOTIFY:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    .line 1795
    iget-object v1, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NAME:Ljava/lang/String;

    sget-object v2, Lcom/android/server/ssrm/fgapps/ScreenMirroringBooster;->STATUS_SECURE_PLAYBACK:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 1796
    iget-object v1, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_VALUE:Ljava/lang/String;
...
.method private onSsrmIntentReceived(Landroid/content/Intent;)V
    ...
    .line 1803
    iget-object v4, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NAME:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_VALUE:Ljava/lang/String;
    ...
    .line 1815
    :cond_0
    sget-object v4, Lcom/android/server/ssrm/fgapps/NavigationScenario;->SSRM_STATUS_NAME_FOR_NAVI:Ljava/lang/String;
...
.method private onSsrmPolicyUpdated(Landroid/content/Intent;)V
    ...
    .line 1761
    .local v1, "gmsBundlingIntentAvailable":Z
    const-string v2, "GMS_BUNDLING_BLACK_LIST"
    ...
    .line 1762
    .local v0, "gmsBundlingBlackList":Ljava/lang/String;
    iget-object v2, p0, Lcom/android/server/ssrm/Monitor;->mLocationBundling:Lcom/android/server/ssrm/fgapps/LocationBundling;

    invoke-virtual {v2, v1, v0}, Lcom/android/server/ssrm/fgapps/LocationBundling;->onPolicyUpdated(ZLjava/lang/String;)V
...
.method private onWifiConnected(Z)V
    ...
    const-string v2, "WLUC trial success."

    invoke-static {v1, v2}, Lcom/android/server/ssrm/Monitor;->logOnEng(Ljava/lang/String;Ljava/lang/String;)V

    .line 1887
    iput v3, p0, Lcom/android/server/ssrm/Monitor;->mWifiCount:I
    ...
    .line 1895
    :cond_1
    iget v1, p0, Lcom/android/server/ssrm/Monitor;->mWifiCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/android/server/ssrm/Monitor;->mWifiCount:I
    ...
    const-string v3, "WLUC connection try..... "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/ssrm/Monitor;->mWifiCount:I
...
.method private declared-synchronized readThermistorFile()Z
    ...
    sget-boolean v5, Lcom/android/server/ssrm/Feature;->MODEL_MILLET_ATT:Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/ssrm/Monitor;->logOnAll(Ljava/lang/String;Ljava/lang/String;)V
...
.method private registerFgAppListeners()V
    ...
    .line 639
    const-class v0, Lcom/android/server/ssrm/fgapps/LocationBundling;
    ...
    .line 647
    const-class v0, Lcom/android/server/ssrm/fgapps/GovernorSC7715;

    sget-boolean v3, Lcom/android/server/ssrm/Feature;->IS_SCX15:Z
    ...
    sget-boolean v0, Lcom/android/server/ssrm/Feature;->MODEL_BERLUTI:Z

    if-nez v0, :cond_1

    sget-boolean v0, Lcom/android/server/ssrm/Feature;->MODEL_MEGA2_3G:Z
    ...
    .line 651
    const-class v0, Lcom/android/server/ssrm/fgapps/GovernorSD8930;

    sget-boolean v3, Lcom/android/server/ssrm/Feature;->MODEL_QUALCOMM_GOLDEN:Z

    invoke-static {v0, v3}, Lcom/android/server/ssrm/Monitor;->registerFgAppListener(Ljava/lang/Class;Z)V

    .line 652
    const-class v3, Lcom/android/server/ssrm/fgapps/GovernorSD8930AB;

    sget-boolean v0, Lcom/android/server/ssrm/Feature;->MODEL_SERRANO:Z

    if-nez v0, :cond_2

    sget-boolean v0, Lcom/android/server/ssrm/Feature;->MODEL_MELIUS:Z

    if-nez v0, :cond_2

    sget-boolean v0, Lcom/android/server/ssrm/Feature;->MODEL_QUALCOMM_LT02:Z
    ...
    .line 654
    const-class v0, Lcom/android/server/ssrm/fgapps/GovernorSD8960;

    sget-boolean v3, Lcom/android/server/ssrm/Feature;->MODEL_D2:Z
    ...
    .line 656
    const-class v3, Lcom/android/server/ssrm/fgapps/GovernorSD8974Pro;
    ...
    sget-boolean v0, Lcom/android/server/ssrm/Feature;->MODEL_KAM:Z
    ...
    .line 668
    const-class v3, Lcom/android/server/ssrm/fgapps/FtatAffinity;
    ...
    sget-boolean v3, Lcom/android/server/ssrm/Feature;->SSRM_TOUCH_REPORT_RATE_CHANGE:Z
    ...
    sget-boolean v3, Lcom/android/server/ssrm/Feature;->DYNAMIC_ANALYSIS:Z
    ...
    check-cast v0, Lcom/android/server/ssrm/fgapps/LocationBundling;

    iput-object v0, p0, Lcom/android/server/ssrm/Monitor;->mLocationBundling:Lcom/android/server/ssrm/fgapps/LocationBundling;
...
.method private requestWlucPolicyUpdate()V
    .locals 3
...
.method private updateSimpleConditionsWithName()V
    ...
    const-string v10, "HotGameControl5"
    ...
    .line 423
    const-string v9, "HotGameControl5"

    invoke-static {v9, v11}, Lcom/android/server/ssrm/ConditionUpdateHelper;->getInstance(Ljava/lang/String;Z)Lcom/android/server/ssrm/ConditionUpdateHelper;

    move-result-object v9

    sget-object v10, Lcom/android/server/ssrm/HotGameList;->HotGameGroup5:[Ljava/lang/String;
...
.method enableAcl(Z)V
    ...
    iget-object v2, p0, Lcom/android/server/ssrm/Monitor;->ACL_SYSFS_PATH:Ljava/lang/String;
...
.method public initHandlerThread()V
    ...
    .line 787
    sget-boolean v0, Lcom/android/server/ssrm/Feature;->WLUC_SUPPORT:Z

    if-eqz v0, :cond_0

    .line 788
    new-instance v0, Lcom/android/server/ssrm/wluc/Wluc;

    iget-object v1, p0, Lcom/android/server/ssrm/Monitor;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/ssrm/Monitor;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, v1, v2}, Lcom/android/server/ssrm/wluc/Wluc;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/ssrm/Monitor;->mWluc:Lcom/android/server/ssrm/wluc/Wluc;
...
.method onForegroundAppChanged(Ljava/lang/String;I)V
    ...
    .line 1572
    sget-boolean v1, Lcom/android/server/ssrm/Monitor;->sKnoxVer2:Z

    if-nez v1, :cond_2

    .line 1573
    invoke-static {p1}, Lcom/android/server/ssrm/Monitor;->checkPrefixAndMarkKnoxSystemProperty(Ljava/lang/String;)V
...
.method onReceiveBroadcastIntent(Landroid/content/Intent;)V
    ...
    .line 1677
    sget-boolean v6, Lcom/android/server/ssrm/Feature;->SSRM_TOUCH_SEPARATION:Z
    ...
    invoke-virtual {v6, v1, p1}, Lcom/android/server/ssrm/TouchSeparation;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V

    .line 1681
    :cond_0
    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->mContext:Landroid/content/Context;

    invoke-static {v6, p1}, Lcom/android/server/ssrm/SortingMachine;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 1687
    :cond_3
    const-string v6, "android.intent.action.USB_CHARGING"
    ...
    .line 1699
    :cond_9
    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NOTIFY:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NOTIFY_KNOX:Ljava/lang/String;
    ...
    .line 1701
    :cond_b
    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->RESPONSE_AXT9INFO:Ljava/lang/String;
    ...
    .line 1703
    :cond_c
    const-string v6, "android.intent.action.SECURE_PLAYBACK_START"
    ...
    .line 1705
    :cond_d
    const-string v6, "android.intent.action.SECURE_PLAYBACK_STOP"
    ...
    .line 1709
    :cond_f
    const-string v6, "com.sec.android.intent.action.DVFS_POLARIS_PDF_VIEW"
    ...
    const-string/jumbo v6, "sec_container_1.com.sec.android.intent.action.DVFS_POLARIS_PDF_VIEW"
    ...
    .line 1715
    :cond_12
    const-string v6, "android.intent.action.START_NETWORK_BOOSTER"
    ...
    const-string v6, "android.intent.action.STOP_NETWORK_BOOSTER"
    ...
    invoke-direct {p0, v5}, Lcom/android/server/ssrm/Monitor;->onNetworkBoosterEnabled(Z)V
    ...
    .line 1719
    sget-boolean v6, Lcom/android/server/ssrm/Monitor;->sKnoxVer2:Z
    ...
    :cond_16
    sput-boolean v5, Lcom/android/server/ssrm/DeviceStatus;->sKnoxMode:Z
    ...
    :cond_17
    const-string v6, "com.sec.intent.ACTION.SSRM_POLICY_RESULT"
    ...
    .line 1724
    invoke-direct {p0, p1}, Lcom/android/server/ssrm/Monitor;->onSsrmPolicyUpdated(Landroid/content/Intent;)V
    ...
    .line 1726
    invoke-direct {p0, p1}, Lcom/android/server/ssrm/Monitor;->onPackageReplaced(Landroid/content/Intent;)V
    ...
    .line 1729
    .local v3, "state":I
    sget-object v6, Lcom/android/server/ssrm/Monitor;->TAG:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "WLUC wifi conntection state = "
    ...
    invoke-static {v6, v7}, Lcom/android/server/ssrm/Monitor;->logOnEng(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1731
    invoke-direct {p0, v5}, Lcom/android/server/ssrm/Monitor;->onWifiConnected(Z)V
    ...
    :cond_1a
    const-string v5, "com.samsung.check.update.schedule"
    ...
    .line 1734
    iget-object v5, p0, Lcom/android/server/ssrm/Monitor;->mHandler:Landroid/os/Handler;
...
.method onSipChanged(Landroid/content/Intent;)V
    ...
    .line 1401
    :try_start_0
    iget-object v1, p0, Lcom/android/server/ssrm/Monitor;->IS_VISIBLE_WINDOW:Ljava/lang/String;
...
.method registerCommands()V
    ...
    .prologue
    .line 2060
    sget-object v2, Lcom/android/server/ssrm/Monitor;->sCmdTable:Ljava/util/Hashtable;

    const-string v3, "TYPE_WINDOW_ORIENTATION"

    new-instance v4, Lcom/android/server/ssrm/Monitor$26;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$26;-><init>(Lcom/android/server/ssrm/Monitor;)V
    ...
    const-string v3, "MULTIVERSE_FINGER_HOVER"

    new-instance v4, Lcom/android/server/ssrm/Monitor$27;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$27;-><init>(Lcom/android/server/ssrm/Monitor;)V
    ...
    const-string v3, "MULTIVERSE_SIDE_KEY"

    new-instance v4, Lcom/android/server/ssrm/Monitor$28;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$28;-><init>(Lcom/android/server/ssrm/Monitor;)V
    ...
    const-string v3, "CAMERA_SIDE_KEY"

    new-instance v4, Lcom/android/server/ssrm/Monitor$29;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$29;-><init>(Lcom/android/server/ssrm/Monitor;)V
    ...
    new-instance v4, Lcom/android/server/ssrm/Monitor$30;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$30;-><init>(Lcom/android/server/ssrm/Monitor;)V
    ...
    const-string v3, "SBROWSER_DASH_MODE"

    new-instance v4, Lcom/android/server/ssrm/Monitor$31;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$31;-><init>(Lcom/android/server/ssrm/Monitor;)V
    ...
    invoke-static {v2}, Lcom/android/server/ssrm/Monitor;->x([I)Ljava/lang/String;

    move-result-object v1

    .line 2215
    .local v1, "DROP_CACHES_SYSFS_PATH":Ljava/lang/String;
    sget-object v2, Lcom/android/server/ssrm/Monitor;->sCmdTable:Ljava/util/Hashtable;

    const-string v3, "REQ_DROP_CACHE"

    new-instance v4, Lcom/android/server/ssrm/Monitor$32;

    invoke-direct {v4, p0, v1}, Lcom/android/server/ssrm/Monitor$32;-><init>(Lcom/android/server/ssrm/Monitor;Ljava/lang/String;)V
    ...
    .line 2231
    .local v0, "BUS_DCVS_SYSFS_PATH":Ljava/lang/String;
    sget-object v2, Lcom/android/server/ssrm/Monitor;->sCmdTable:Ljava/util/Hashtable;

    const-string v3, "BUS_DCVS_GOVERNOR"

    new-instance v4, Lcom/android/server/ssrm/Monitor$33;

    invoke-direct {v4, p0, v0}, Lcom/android/server/ssrm/Monitor$33;-><init>(Lcom/android/server/ssrm/Monitor;Ljava/lang/String;)V
    ...
    const-string v3, "GENERAL_SHELL"

    new-instance v4, Lcom/android/server/ssrm/Monitor$34;

    invoke-direct {v4, p0}, Lcom/android/server/ssrm/Monitor$34;-><init>(Lcom/android/server/ssrm/Monitor;)V
...
.method public registerIntentFilters()V
    ...
    iget-object v1, v0, Lcom/android/server/ssrm/Monitor;->RESPONSE_AXT9INFO:Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NOTIFY:Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/android/server/ssrm/Monitor;->SSRM_STATUS_NOTIFY_KNOX:Ljava/lang/String;
    ...
    iget-object v13, v0, Lcom/android/server/ssrm/Monitor;->SSRM_NOTIFICATION_PERMISSION:Ljava/lang/String;
    ...
    .line 1269
    const-string/jumbo v1, "sec_container_1.com.sec.android.intent.action.DVFS_POLARIS_PDF_VIEW"
    ...
    .line 1273
    .local v20, "filter5":Landroid/content/IntentFilter;
    ...
    iget-object v0, v0, Lcom/android/server/ssrm/Monitor;->mContext:Landroid/content/Context;

    move-object/from16 v17, v0

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/ssrm/Monitor;->mIntentReceiver:Landroid/content/BroadcastReceiver;

    move-object/from16 v18, v0

    sget-object v19, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const-string v21, "android.permission.DEVICE_POWER"
    ...
    .line 1278
    .local v24, "filter6":Landroid/content/IntentFilter;
