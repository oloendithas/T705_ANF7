...
.method private onLocationReport([Landroid/location/Location;)V
    ...
    .line 126
    .local v6, "sink":Landroid/hardware/location/IFusedLocationHardwareSink;
    monitor-exit v8
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 133
    .local v5, "mLocService":Lcom/samsung/location/ISLocationManager;
    if-eqz v5, :cond_2
    ...
    .line 143
    .end local v5    # "mLocService":Lcom/samsung/location/ISLocationManager;
    :cond_2
    :goto_1
    return-void

    .line 126
    .end local v6    # "sink":Landroid/hardware/location/IFusedLocationHardwareSink;
    :catchall_0
    move-exception v7
    ...
    .line 136
    .restart local v5    # "mLocService":Lcom/samsung/location/ISLocationManager;
    .restart local v6    # "sink":Landroid/hardware/location/IFusedLocationHardwareSink;
    :catch_0
    move-exception v1
