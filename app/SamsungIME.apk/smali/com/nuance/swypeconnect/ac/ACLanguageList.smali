...
.method static constructor <clinit>()V
    ...
    .line 92
    .local v7, "map":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
...
.method public static findLanguageByLanguageId(I)Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;
    ...
    .line 226
    .local v0, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    ...
    invoke-virtual {v2}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->getXT9Id()I
    ...
    .line 230
    .end local v0    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    :goto_0
    return-object v2
...
.method public static findLanguageIdByFullLangCode(Ljava/lang/String;)I
    ...
    .line 208
    .local v0, "codeParts":[Ljava/lang/String;
    array-length v4, v0
    ...
    .line 211
    :cond_0
    sget-object v4, Lcom/nuance/swypeconnect/ac/ACLanguageList;->languageList:Ljava/util/Map;
    ...
    .line 212
    .local v2, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    ...
    # getter for: Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->isoCodeFull:Ljava/lang/String;
    invoke-static {v4}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->access$000(Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->getXT9Id()I

    move-result v4

    .line 221
    .end local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    :goto_0
    return v4
    ...
    .line 217
    .restart local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    invoke-interface {v2}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;
...
.method public static findLanguageNameById(I)Ljava/lang/String;
    ...
    # getter for: Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->englishName:Ljava/lang/String;
    invoke-static {v2}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->access$100(Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;)Ljava/lang/String;
...
.method public static getChineseLanguages()Ljava/util/List;
    ...
    .line 257
    .local v2, "languageIds":Ljava/util/List;, "Ljava/util/List<Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    sget-object v3, Lcom/nuance/swypeconnect/ac/ACLanguageList;->languageList:Ljava/util/Map;
    ...
    .line 258
    .local v1, "l":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    invoke-interface {v1}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;

    # getter for: Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->core:I
    invoke-static {v3}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->access$300(Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;)I
    ...
    .line 262
    .end local v1    # "l":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    :cond_1
    return-object v2
.end method
...
.method public static declared-synchronized getLanguageCoreMap()Ljava/util/HashMap;
    ...
    .prologue
    .line 244
    const-class v7, Lcom/nuance/swypeconnect/ac/ACLanguageList;

    monitor-enter v7

    :try_start_0
    sget-object v6, Lcom/nuance/swypeconnect/ac/ACLanguageList;->languageCoreList:Ljava/util/HashMap;
    ...
    sput-object v6, Lcom/nuance/swypeconnect/ac/ACLanguageList;->languageCoreList:Ljava/util/HashMap;

    .line 246
    sget-object v6, Lcom/nuance/swypeconnect/ac/ACLanguageList;->languageList:Ljava/util/Map;
    ...
    .line 247
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    invoke-interface {v1}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;

    # getter for: Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->xt9LangId:[I
    invoke-static {v6}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->access$200(Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;)[I
    ...
    .line 248
    .local v4, "id":I
    sget-object v8, Lcom/nuance/swypeconnect/ac/ACLanguageList;->languageCoreList:Ljava/util/HashMap;
    ...
    invoke-virtual {v6}, Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;->getCore()I
    ...
    .line 252
    .end local v0    # "arr$":[I
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    .end local v3    # "i$":I
    .end local v4    # "id":I
    .end local v5    # "len$":I
    :cond_1
    ...
    .line 244
    .restart local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/nuance/swypeconnect/ac/ACLanguageList$Language;>;"
    :catchall_0
    move-exception v6
