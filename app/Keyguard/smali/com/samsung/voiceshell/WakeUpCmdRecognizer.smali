...
.field public static UDTMultiAPrecog:Ljava/lang/String;

.field public static UDTMultiAPsearch:Ljava/lang/String;

.field public static customVoiceTalkEnablePath:Ljava/lang/String;

.field private static isEnrollReady:Z

.field public static mExist:[I

.field public static m_lastEnroll_0:Ljava/lang/String;

.field public static m_lastEnroll_1:Ljava/lang/String;

.field public static m_lastEnroll_2:Ljava/lang/String;

.field public static m_lastEnroll_3:Ljava/lang/String;

.field public static m_lastEnroll_4:Ljava/lang/String;

.field public static m_lastEnroll_5:Ljava/lang/String;
...
.method public constructor <init>(Lcom/samsung/voiceshell/VoiceEngineResultListener;Ljava/lang/String;)V
    ...
    const-string v1, "secMM: WakeUpCmdRecognizer Create, Set data, package"
...
.method private InitializeVerify()I
    ...
    .line 1159
    :goto_6
    invoke-static {v4}, Lcom/samsung/voiceshell/AudioRecordHaydn;->SetRecordingMode(I)V
    ...
    sget-object v3, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->mExist:[I

    invoke-virtual {v0, v1, v2, v3}, Lcom/samsung/voiceshell/VoiceEngine;->checkFileExistence(Ljava/lang/String;I[I)I
    ...
    const-string v3, "Number of complete sets: "
    ...
    const-string v2, "SECURE LOCK-SCREEN with WType: "
    ...
    const-string v2, "NORMAL LOCK-SCREEN with WType: "
    ...
    const-string v2, "VOICE-TALK with Wtype: "
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/samsung/voiceshell/VoiceEngine;->initializeVerify(Ljava/lang/String;Ljava/lang/String;I)I
...
.method private StartVerify()I
    ...
    const-string v1, "secMM: StartVerify, Failed to do startRecord"
    ...
    invoke-virtual {v0}, Lcom/samsung/voiceshell/VoiceEngine;->startVerify()I
...
.method private isNewVersionSensoryLib()Z
    ...
    const-string v1, "Error : Could not find libSensoryWakeUpEngine.so"
...
.method private isSamsungVoiceLib()Z
    ...
    const-string v1, "Error : Could not find libSamsungVoiceEngine.so"
...
.method private isSensoryLib()Z
    ...
    const-string v2, "/system/lib/libWakeUpSensory.so"
    ...
    iget-object v3, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->acousticModelPathname:Ljava/lang/String;
    ...
    const-string v2, "Error : Could not find libWakeUpSensory.so or libSensoryWakeUpEngine.so"
    ...
    const-string v2, "Error : Could not find sensoryAcousticModelFile"
    ...
    const-string v2, "Error : Could not find sensorySearchGrammarFile"
...
.method private waitForBackgroundEnroll()V
    ...
    .line 910
    iput-boolean v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isRunning_all:Z
    ...
    const-string v1, "waitForBackgroundEnroll"
...
.method protected InitializeEnroll()I
    ...
    .line 1003
    invoke-static {v0}, Lcom/samsung/voiceshell/AudioRecordHaydn;->SetRecordingMode(I)V
    ...
    .line 1008
    sput-boolean v5, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isEnrollReady:Z
    ...
    invoke-virtual {v1, v0}, Lcom/samsung/voiceshell/VoiceEngine;->setMode(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/voiceshell/VoiceEngine;->initializeEnroll(Ljava/lang/String;)I
...
.method protected ProcessEnroll()I
    ...
    .line 1042
    iget-object v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->conflictCommandType:[S
    ...
    iget-object v3, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->conflictCommandType:[S

    invoke-virtual {v0, v1, v2, v3}, Lcom/samsung/voiceshell/VoiceEngine;->processEnroll(Ljava/lang/String;S[S)I
...
.method protected TerminateEnroll()I
    ...
    invoke-virtual {v0}, Lcom/samsung/voiceshell/VoiceEngine;->terminateEnroll()I
...
.method public choiceMultipleWakeUpIntent(I)Landroid/content/Intent;
    ...
    const-string v3, "secMM: choiceMultipleWakeUpIntent, functionAssignment error!"
    ...
    const-string v4, "secMM: choiceMultipleWakeUpIntent, resultCommand : "
    ...
    const-string v3, "secMM: choiceMultipleWakeUpIntent, resultCommand is none : "
    ...
    const-string v3, "secMM: choiceMultipleWakeUpIntent, intent : "
    ...
    .line 1258
    const-string v1, "custom.wakeup.screen"
    ...
    iget-object v1, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->mContext:Landroid/content/Context;

    invoke-static {v0, v1}, Lcom/samsung/voiceshell/MultipleWakeUp;->getMultipleWakeUpIntent(ILandroid/content/Context;)Landroid/content/Intent;
    ...
    const-string v2, "secMM: choiceMultipleWakeUpIntent, intent is null"
...
.method protected sensoryProcessEnroll()I
    ...
    const-string v2, "secMM: sensoryProcessEnroll, Failed to do startRecord"
    ...
    iget-boolean v1, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->sensoryUDTSIDThreadEnable:Z
    ...
    const-string v2, "secMM: stop sensoryProcessEnroll"
    ...
    const-string v2, "secMM: sensoryProcessEnroll, mDummyRecorder is null"
...
.method public setLanguage()V
    ...
    invoke-direct {p0, v2}, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->readString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isEnableChineseWakeUp:Z
    ...
    iget-boolean v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isEnableJapaneseWakeUp:Z
    ...
    iget-boolean v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isEnableRussianWakeUp:Z
    ...
    iget-boolean v1, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isEnableChineseWakeUp:Z
    ...
    iget-boolean v1, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isEnableJapaneseWakeUp:Z
...
.method public setNewVersionLanguage()V
    ...
    .line 1524
    sget-object v4, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->sVoiceLanguageFilePath:Ljava/lang/String;

    invoke-direct {p0, v4}, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->readString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1667
    sget-object v2, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->UDTAlwaysAPrecog:Ljava/lang/String;
    ...
    sget-object v2, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->UDTAlwaysAPsearch:Ljava/lang/String;
...
.method public startVerify(I)I
    ...
    :try_end_9b
    .catch Ljava/lang/InterruptedException; {:try_start_98 .. :try_end_9b} :catch_c3
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/voiceshell/AudioRecordHaydn;->setWeHaveNoModel(Z)V
    ...
    invoke-interface {v1, v7, v5}, Lcom/samsung/voiceshell/VoiceEngineResultListener;->OnVerifyResult(IS)V
