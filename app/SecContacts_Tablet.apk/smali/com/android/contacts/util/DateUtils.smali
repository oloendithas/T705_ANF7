...
.method public static formatDate(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 195
    .local v6, "parsePosition":Ljava/text/ParsePosition;
    const-string v8, "--02-29"
    ...
    invoke-static {v7, v4, v8}, Lcom/android/contacts/util/DateUtils;->getUtcDate(III)Ljava/util/Date;
    ...
    .line 222
    .local v5, "outFormat":Ljava/text/DateFormat;
    sget-object v7, Lcom/android/contacts/util/DateUtils;->UTC_TIMEZONE:Ljava/util/TimeZone;
    ...
    .end local v4    # "noYearParsed":Z
    .end local v5    # "outFormat":Ljava/text/DateFormat;
    :cond_3
    ...
    .line 200
    :try_start_1
    sget-object v9, Lcom/android/contacts/util/DateUtils;->NO_YEAR_DATE_FORMAT:Ljava/text/SimpleDateFormat;

    invoke-virtual {v9, p1, v6}, Ljava/text/SimpleDateFormat;->parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    .restart local v4    # "noYearParsed":Z
    :goto_3
    goto :goto_1
    ...
    .local v3, "i":I
    :goto_6
    sget-object v7, Lcom/android/contacts/util/DateUtils;->DATE_FORMATS:[Ljava/text/SimpleDateFormat;
    ...
    .line 232
    invoke-virtual {v2, p1, v6}, Ljava/text/SimpleDateFormat;->parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    .line 235
    .restart local v5    # "outFormat":Ljava/text/DateFormat;
    sget-object v7, Lcom/android/contacts/util/DateUtils;->UTC_TIMEZONE:Ljava/util/TimeZone;
...
.method public static formatDateForLunar(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 115
    .local v6, "tempStr":Ljava/lang/StringBuilder;
    const/4 v4, 0x0
